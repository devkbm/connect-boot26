...
DROP TABLE IF EXISTS GRWBOARDBOOKMARK;

CREATE TABLE GRWBOARDBOOKMARK (
	SYS_DT			DATETIME		NULL		COMMENT '최초등록일시',
	SYS_USER		VARCHAR(50)		NULL		COMMENT '최초등록유저',
	UPD_DT			DATETIME		NULL		COMMENT '최종수정일시',
	UPD_USER		VARCHAR(50)		NULL		COMMENT '최종수정유저',
	PK_BOOKMARK		INT				NOT NULL	AUTO_INCREMENT COMMENT '게시판즐겨찾기 키',
	USER_ID			VARCHAR(50)		NULL		COMMENT '사용자ID',
	FK_BOARD		INT				NULL		COMMENT '게시판키',			   
	SEQ				INT				NULL		COMMENT '순번',	
    constraint pk_grwboardbookmark 	primary key(PK_BOOKMARK)    
) COMMENT = '게시판즐겨찾기관리';
